...
adminRecencement({required BuildContext context}) {
            ...
            Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('Gestion des Recencements'),
                        Spacer(),
                        GestureDetector(
                          onTap: () => adminTroupeaux(context: context),
                          child: Container(
                            /* width: size.width * .1, */
                            child: Column(
                              children: [
                        ...
                        GestureDetector(
                          onTap: () => adminAnimaux(context: context),
                          child: Container(
                            /* width: size.width * .1, */
                            child: Column(
                              children: [
