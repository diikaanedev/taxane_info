                           ...
                           FirebaseFirestore.instance.collection('membres').get().then((value)  {
                             String idMembre = 'nothing';
                              ...
                              for (var item in value.docs) {
                                 print("e.get('matricule') => ${item.get("matricule")}");
                                  if (item.get("matricule").toString().toLowerCase().trim() == codeMembre.text.toLowerCase().trim()) {
                            ...
                            if (idMembre !='nothing') {
                               FirebaseFirestore.instance.collection("champs").add({
                                ...
                                "geoPoint" : GeoPoint(double.parse(lattitude.text), double.parse(longitude.text)), 
                                "date": DateTime.now()
