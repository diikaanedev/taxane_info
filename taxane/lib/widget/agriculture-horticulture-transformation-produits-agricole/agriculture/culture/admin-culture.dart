...
import 'package:taxane/widget/agriculture-horticulture-transformation-produits-agricole/agriculture/culture/dialog-culture.dart';

adminCulture({required BuildContext context}) {
            ...
            child: Row(
              children: [
                ...
                Spacer(),
                  ...
                  GestureDetector(
                  onTap: () => addCulture(context: context),
                  child: Container(
                    width: size.width * .1,
                    child: Column(
                      children: [
