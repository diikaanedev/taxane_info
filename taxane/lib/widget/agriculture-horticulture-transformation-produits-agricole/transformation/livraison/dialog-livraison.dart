...
addLivraison({required BuildContext context}) {
  ...
  showDialog(context: context, builder: (context) {
    TextEditingController code =
                ...
                TextEditingController();
                            TextEditingController prix_total =
                TextEditingController();
    return AlertDialog(
    content: Container(
                      ...
                      onTap: () async {
                         FirebaseFirestore.instance.collection('point-de-ventes').get().then((value)  {
                            ...
                            if (idPtDeVente !='nothing') {
                               FirebaseFirestore.instance.collection("livraisons").add({
                                "code" :code.text,
