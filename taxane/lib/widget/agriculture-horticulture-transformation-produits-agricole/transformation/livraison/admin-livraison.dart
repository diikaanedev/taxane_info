...
import 'package:taxane/widget/agriculture-horticulture-transformation-produits-agricole/transformation/livraison/dialog-livraison.dart';

adminLivraison({required BuildContext context}) {
            ...
            child: Row(
              children: [
                ...
                Spacer(),
                 ...
                 GestureDetector(
                  onTap: () => addLivraison(context: context),
                  child: Container(
                    /* width: size.width * .1, */
                    child: Column(
                      children: [
