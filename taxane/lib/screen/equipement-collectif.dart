...
late _EquipementCollectifState equipementCollectifState;

class EquipementCollectif extends StatefulWidget {
  const EquipementCollectif({Key? key}) : super(key: key);

  @override
  _EquipementCollectifState createState() {
    equipementCollectifState = _EquipementCollectifState();
    return equipementCollectifState;
  }
}
